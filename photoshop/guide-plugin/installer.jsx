...
(function() {
  ...
  G = {
    ...
    COMPANY: "GuideGuide",
    CONTACT_INFO: "guideguide@cameronmcefee.com",
    PRODUCT_NAME: "GuideGuide",
    PRODUCT_ID: "GuideGuide",
    PRODUCT_VERSION: "4.1.6",
    /* PRODUCTS ===================================*/
    ...
    HTML_PANEL: "files/manual-install/GuideGuide",
    FLASH_PANEL: void 0,
    SCRIPT: void 0,
    MAC_PLUGIN: void 0,
    WIN_PLUGIN: void 0,
  ...
  */
  ...
  PSU = (function(GLOBAL) {
    var createFolder, exceptionMessage, init, isMac, isWindows, log, recursivelyDeleteThing, that, throwFileError;
    that = this;
    ...
    */
    ...
    recursivelyDeleteThing = function(thingToDestroy) {
      var aFile, aFolder, e, inFiles, inFolders, processFolder, _i, _j, _len, _len1;
      inFolders = [];
      inFiles = [];
      processFolder = function(fold) {
        var aThing, fileList, _i, _len, _results;
        ...
        for (_i = 0, _len = fileList.length; _i < _len; _i++) {
          ...
          if (aThing instanceof Folder) {
            ...
            _results.push(processFolder(aThing));
          } else {
            _results.push(inFiles.push(aThing));
          }
        }
        return _results;
      };
      ...
      if (thingToDestroy instanceof Folder) {
        ...
        for (_j = 0, _len1 = inFolders.length; _j < _len1; _j++) {
          aFolder = inFolders[_j];
          try {
            aFolder.remove();
          } catch (_error) {
            e = _error;
    ...
    */
    ...
    return {
      ...
      "init": init,
      "recursivelyDeleteThing": recursivelyDeleteThing
    };
  })(this);
  ...
  PSInstaller = (function() {
    ...
    */
    ...
    function PSInstaller() {
      ...
      G.LOG_FILE_PATH = new File(G.CURRENT_PATH);
    ...
    */
    ...
    PSInstaller.prototype.copy = function() {
      var allFiles, copyFiles, createRelativeFolder, destinationFolder, destinationPath, eachFolder, existingInstall, getFoldersList, ignoreRegExp, panelsPath, pluginsPath, product, saveFolder, scriptsPath, sourceFolder, that, _i, _j, _len, _len1, _ref, _ref1, _results;
      that = this;
      /*
      ...
      */
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        existingInstall = Folder(destinationPath);
        if (existingInstall.exists) {
          PSU.log("Deleting existing folder at: " + existingInstall.fsName);
          PSU.recursivelyDeleteThing(existingInstall);
        }
